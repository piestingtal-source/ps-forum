...
<div class="psf-forum-header">
	...
	<div class="psf-meta">
		...
		<span class="psf-forum-post-date"><?php printf( __( 'Zuletzt aktualisiert %s', 'psforum' ), psf_get_forum_last_active_time() ); ?></span>
	...
	<div class="psf-forum-title">
		...
		<h3><?php _e( 'Forum: ', 'psforum' ); ?><a href="<?php psf_forum_permalink(); ?>"><?php psf_forum_title(); ?></a></h3>
