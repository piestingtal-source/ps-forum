...
<form role="search" method="get" id="psf-search-form" action="<?php psf_search_url(); ?>">
	<div>
		<label class="screen-reader-text hidden" for="psf_search"><?php _e( 'Suchen nach:', 'psforum' ); ?></label>
		...
		<input tabindex="<?php psf_tab_index(); ?>" class="button" type="submit" id="psf_search_submit" value="<?php esc_attr_e( 'Suche', 'psforum' ); ?>" />
	</div>
</form>
