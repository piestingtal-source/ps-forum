 ...
 *
 * @since PSForum (r5140)
 * @link Codex Docs http://codex.psforum.org/import-forums/mybb
 */
class MyBB extends PSF_Converter_Base {
	...
	public function setup_globals() {
		...
		$this->field_map[] = array(
			...
			'from_fieldname' => 'icq',
			'to_type'        => 'user',
			'to_fieldname'   => '_psf_mybb_user_icq'
		);
		...
		$this->field_map[] = array(
			...
			'from_fieldname' => 'msn',
			'to_type'        => 'user',
			'to_fieldname'   => '_psf_mybb_user_msn'
		);
		...
		$this->field_map[] = array(
			...
			'to_type'        => 'user',
			'to_fieldname'   => '_psf_mybb_user_sig',
			'callback_method' => 'callback_html'
		);
