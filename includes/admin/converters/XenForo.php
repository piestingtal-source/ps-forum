 ...
 *
 * @since PSForum (r5145)
 * @link Codex Docs http://codex.psforum.org/import-forums/xenforo
 */
class XenForo extends PSF_Converter_Base {
...
/*		// User password.
		...
		$this->field_map[] = array(
			...
			'to_type'         => 'user',
			'to_fieldname'    => '_psf_converter_password'
		);
...
*/
		...
		$this->field_map[] = array(
			...
			'to_type'         => 'user',
			'to_fieldname'    => '_psf_xenforo_user_custom_title'
		);
		...
		$this->field_map[] = array(
			...
			'join_expression' => 'USING (user_id)',
			'to_type'         => 'user',
			'to_fieldname'    => '_psf_xenforo_user_status'
		);
		...
		$this->field_map[] = array(
			...
			'join_type'       => 'LEFT',
			'join_expression' => 'USING (user_id)',
			'to_fieldname'    => '_psf_xenforo_user_sig',
			'to_type'         => 'user',
			'callback_method' => 'callback_html'
		);
		...
		$this->field_map[] = array(
			...
			'join_expression' => 'USING (user_id)',
			'to_type'         => 'user',
			'to_fieldname'    => '_psf_xenforo_user_location'
		);
		...
		$this->field_map[] = array(
			...
			'join_expression' => 'USING (user_id)',
			'to_type'         => 'user',
			'to_fieldname'    => '_psf_xenforo_user_occupation'
		);
		...
		$this->field_map[] = array(
			...
			'join_expression' => 'USING (user_id)',
			'to_type'         => 'user',
			'to_fieldname'    => '_psf_xenforo_user_about',
			'callback_method' => 'callback_html'
		);
	}
