 ...
 *
 * @since PSForum (r5143)
 * @link Codex Docs http://codex.psforum.org/import-forums/xmb
 */
class XMB extends PSF_Converter_Base {
...
//		);
		...
		$this->field_map[] = array(
			...
			'from_fieldname' => 'icq',
			'to_type'        => 'user',
			'to_fieldname'   => '_psf_xmb_user_icq'
		);
		...
		$this->field_map[] = array(
			...
			'from_fieldname' => 'msn',
			'to_type'        => 'user',
			'to_fieldname'   => '_psf_xmb_user_msn'
		);
		...
		$this->field_map[] = array(
			...
			'from_fieldname'  => 'sig',
			'to_type'         => 'user',
			'to_fieldname'    => '_psf_xmb_user_sig',
			'callback_method' => 'callback_html'
		);
		...
		$this->field_map[] = array(
			...
			'from_fieldname'  => 'bio',
			'to_type'         => 'user',
			'to_fieldname'    => '_psf_xmb_user_bio',
			'callback_method' => 'callback_html'
		);
		...
		$this->field_map[] = array(
			...
			'to_type'        => 'user',
			'to_fieldname'   => '_psf_xmb_user_location'
		);
		...
		$this->field_map[] = array(
			...
			'to_type'        => 'user',
			'to_fieldname'   => '_psf_xmb_user_avatar'
		);
		...
		$this->field_map[] = array(
			...
			'from_fieldname' => 'mood',
			'to_type'        => 'user',
			'to_fieldname'   => '_psf_xmb_user_mood'
		);
