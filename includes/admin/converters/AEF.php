 ...
 *
 * @since PSForum (r5139)
 * @link Codex Docs http://codex.psforum.org/import-forums/aef
 */
class AEF extends PSF_Converter_Base {
	...
	public function setup_globals() {
		...
		$this->field_map[] = array(
			...
			'from_fieldname' => 'icq',
			'to_type'        => 'user',
			'to_fieldname'   => '_psf_aef_user_icq'
		);
		...
		$this->field_map[] = array(
			...
			'from_fieldname' => 'msn',
			'to_type'        => 'user',
			'to_fieldname'   => '_psf_aef_user_msn'
		);
		...
		$this->field_map[] = array(
			...
			'to_type'        => 'user',
			'to_fieldname'   => '_psf_aef_user_gmail'
		);
		...
		$this->field_map[] = array(
			...
			'from_fieldname' => 'sig',
			'to_type'        => 'user',
			'to_fieldname'   => '_psf_aef_user_sig',
			'callback_method' => 'callback_html'
		);
		...
		$this->field_map[] = array(
			...
			'to_type'        => 'user',
			'to_fieldname'   => '_psf_aef_user_location'
		);
		...
		$this->field_map[] = array(
			...
			'to_type'        => 'user',
			'to_fieldname'   => '_psf_aef_user_private_text'
		);
