 ...
 *
 * @since PSForum (r4724)
 * @link Codex Docs http://codex.psforum.org/import-forums/vbulletin
 */
class vBulletin extends PSF_Converter_Base {
	...
	private function setup_globals() {
		...
		$this->field_map[] = array(
			...
			'from_fieldname' => 'icq',
			'to_type'        => 'user',
			'to_fieldname'   => '_psf_vbulletin_user_icq'
		);
		...
		$this->field_map[] = array(
			...
			'from_fieldname' => 'msn',
			'to_type'        => 'user',
			'to_fieldname'   => '_psf_vbulletin_user_msn'
		);
		...
		$this->field_map[] = array(
			...
			'to_type'        => 'user',
			'to_fieldname'   => '_psf_vbulletin_user_skype'
		);
	}
