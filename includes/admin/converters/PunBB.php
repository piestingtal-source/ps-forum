 ...
 *
 * @since PSForum (r5153)
 * @link Codex Docs http://codex.psforum.org/import-forums/punbb
 */
class PunBB extends PSF_Converter_Base {
	...
	public function setup_globals() {
		...
		$this->field_map[] = array(
			...
			'from_fieldname' => 'icq',
			'to_type'        => 'user',
			'to_fieldname'   => '_psf_punbb_user_icq'
		);
		...
		$this->field_map[] = array(
			...
			'from_fieldname' => 'msn',
			'to_type'        => 'user',
			'to_fieldname'   => '_psf_punbb_user_msn'
		);
		...
		$this->field_map[] = array(
			...
			'to_type'        => 'user',
			'to_fieldname'   => '_psf_punbb_user_facebook'
		);
		...
		$this->field_map[] = array(
			...
			'to_type'        => 'user',
			'to_fieldname'   => '_psf_punbb_user_twitter'
		);
		...
		$this->field_map[] = array(
			...
			'to_type'        => 'user',
			'to_fieldname'   => '_psf_punbb_user_linkedin'
		);
		...
		$this->field_map[] = array(
			...
			'to_type'        => 'user',
			'to_fieldname'   => '_psf_punbb_user_skype'
		);
		...
		$this->field_map[] = array(
			...
			'to_type'        => 'user',
			'to_fieldname'   => '_psf_punbb_user_sig',
			'callback_method' => 'callback_html'
		);
		...
		$this->field_map[] = array(
			...
			'to_type'        => 'user',
			'to_fieldname'   => '_psf_punbb_user_from'
		);
		...
		$this->field_map[] = array(
			...
			'to_type'        => 'user',
			'to_fieldname'   => '_psf_punbb_user_admin_note'
		);
	}
